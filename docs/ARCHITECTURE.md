...
Format ADR: **Keputusan → Opsi lain → Alasan.**
...
## ADR-03 AI transport: Firebase AI Logic + Gemini
...
## ADR-04 OCR: ML Kit on-device + Gemini vision
...
## ADR-05 Struktur folder: feature-first + layering tipis
...
## ADR-06 Input dari mana saja: OS Share Sheet
